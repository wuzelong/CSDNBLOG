...
<style type="text/css">
body{
 background:url(static/images/SSMadmin_bg.jpg);
 background-size: 100% 100%;
}
</style>
<title>SSM-MALL 后台管理</title>
 <%
...
<!-- 商品修改的模态框 -->
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                    ...
	                    <div class="form-group">
	                        <label for="picture_add_input"  class="col-sm-2 control-label">图片路径</label>
	                        <div class="col-sm-10">
	                            <input type="text" class="form-control" name="picture" id="picture_update_input" placeholder="picture">
	                            <span class="help-block"></span>
	                        </div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                            <textarea cols="35" class="form-control" name="introduction" id="introduction_update_input" placeholder="introduction"></textarea>
	                            <span class="help-block"></span>
	                        </div>
	                    </div>
	            </div>
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                    ...
	                    <div class="form-group">
	                        <label for="picture_add_input"  class="col-sm-2 control-label">图片路径</label>
	                        <div class="col-sm-10">
	                            <input type="text" class="form-control" name="picture" id="picture_add_input" placeholder="picture">
	                            <span class="help-block"></span>
	                        </div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                        <label for="introduction_add_input"  class="col-sm-2 control-label">介绍</label>
	                        <div class="col-sm-10">
	                            <textarea rows="4" cols="35" class="form-control" name="introduction" id="introduction_add_input" placeholder="introduction"></textarea>
	                            <span class="help-block"></span>
	                        </div>
	                    </div>
	            </div>
	...
	<!-- 标题行 -->
		<div class="page-header">
		  <h1>SSM-MALL 后台管理  <em><small id="page-header_small"> welcome </small></em>
		  <a id="user_logout_a"style="margin-left:500px">注销</a></h1>
		</div>
		<!-- 导航 -->
		<div class="btn-group btn-group-lg" role="group" >
		  <button type="button" class="btn btn-warning" id="pro_show_all_btn">查看全部</button>
		  <button type="button" class="btn btn-primary" id="pro_add_modal_btn">新增商品</button>
		  <button type="button" class="btn btn-danger" id="pro_delete_all_btn">批量删除</button>
		  <div class="col-md-6 col-md-offset-2">
	      <div class="input-group">
	        <input type="text" id="pro_search_test" class="form-control" placeholder="Search for...">
...
<script type="text/javascript">
    ...
    //点击显示全部按钮->到所有商品第一页
    $("#pro_show_all_btn").click(function (){
    	to_page(1);
    });
  ...
  //点击查找按钮->跳到查找结果第一页
    ...
    function build_pros_table(result) {
        ...
        $.each(pros,function (index, item) {
            ...
            var pictureTd = $("<td></td>").append($("<img></img>").
            		attr("src",item.picture).attr("width","30%")).attr("width","18%");
    ...
    function getPro(pid) {
        $.ajax({
            ...
            success:function (result) {
                ...
                $("#name_update_input").val(proData.name);
                $("#picture_update_input").val(proData.picture);
